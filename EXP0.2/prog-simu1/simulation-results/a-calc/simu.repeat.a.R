...
x1.u <- 0.6; x2.u <- 0.4; x1.s <- 0.3; x2.s <- 0.1; v.sd <- 0.2
...
set1 <- c(x1.u = 0.6, x2.u = 0.4, x1.s = 0.1, x2.s = 0.3, v.sd = 0.2)
set2 <- c(x1.u = 0.6, x2.u = 0.4, x1.s = 0.3, x2.s = 0.3, v.sd = 0.2)
set3 <- c(x1.u = 0.6, x2.u = 0.4, x1.s = 0.3, x2.s = 0.1, v.sd = 0.2)
