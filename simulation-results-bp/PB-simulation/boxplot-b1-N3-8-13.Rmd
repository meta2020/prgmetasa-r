...
# legend("topleft", c("bnm.p", "tnm.p", "tnm.p2", "bnm.o","tnm.o","tnm.o2",  "sa1", "sa2"), col = 1:8, lty = 1:8, pch = 1:8)
# title("Compared with BNM model")
# axis(1, at = 1:5, labels = seq(0.9, 0.1, -0.2))

x <- rbind(med9, med7, med5, med3, med1)
matplot(x[,c(2,5,7)], ylim = c(0.7, 1), type = "o", ylab = "Med(SAUC)", xlab = "p", xaxt = "n", pch = 1:4)
legend("topleft", c("TNM.p", "TNM.o", "SA.1"), col = 1:4, lty = 1:4, pch = 1:4)
axis(1, at = 1:5, labels = seq(0.9, 0.1, -0.2))


x <- rbind(med9, med7, med5, med3, med1)
matplot(x[,c(1,4,7)], ylim = c(0.7, 1), type = "o", ylab = "Med(SAUC)", xlab = "p", xaxt = "n", pch = 1:4)
legend("topleft", c("BNM.p", "BNM.o", "SA.1"), col = 1:4, lty = 1:4, pch = 1:4)
axis(1, at = 1:5, labels = seq(0.9, 0.1, -0.2))

x <- rbind(med9, med7, med5, med3, med1)
matplot(x[,c(3,6,8)], ylim = c(0.7, 1), type = "o", ylab = "Med(SAUC)", xlab = "p", xaxt = "n", pch = 1:4)
legend("topleft", c("TNM.p2", "TNM.o2", "SA.2"), col = 1:4, lty = 1:4, pch = 1:4)
axis(1, at = 1:5, labels = seq(0.9, 0.1, -0.2))
```
