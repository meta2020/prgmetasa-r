...
x <- rbind(med9, med7, med5, med3, med1)
matplot(x[,c(1,4,8)], ylim = c(0.7, 1), type = "o", ylab = "Med(SAUC)", xlab = "p", xaxt = "n", pch = 1:4)
legend("topleft", c("BNM.p", "BNM.o", "SA.2"), col = 1:4, lty = 1:4, pch = 1:4)
axis(1, at = 1:5, labels = seq(0.9, 0.1, -0.2))
