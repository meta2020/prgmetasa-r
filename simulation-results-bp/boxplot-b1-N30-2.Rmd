...
load("2N30/HR1_p0.8.RData")
sauc <- matrix(DATA[11,], ncol = 3, byrow = TRUE)
med8 <- sapply(1:3, function(i) mean(sauc[,i], na.rm = TRUE))
sd8 <- sapply(1:3, function(i) sd(sauc[,i], na.rm = TRUE))
...
load("2N30/HR1_p0.6.RData")
sauc <- matrix(DATA[11,], ncol = 3, byrow = TRUE)
med6  <- sapply(1:3, function(i) mean(sauc[,i], na.rm = TRUE))
cv  <- matrix(DATA[13,], ncol = 3, byrow = TRUE)
cv6 <- sapply(1:3, function(i) sum(1-cv[,i], na.rm = TRUE)/10)
pro  <- matrix(DATA[12,], ncol = 3, byrow = TRUE)
pro6 <- sapply(1:3, function(i) mean(pro[,i], na.rm = TRUE))

load("2N30/HR1_p0.4.RData")
sauc <- matrix(DATA[11,], ncol = 3, byrow = TRUE)
med4  <- sapply(1:3, function(i) mean(sauc[,i], na.rm = TRUE))
cv  <- matrix(DATA[13,], ncol = 3, byrow = TRUE)
cv4 <- sapply(1:3, function(i) sum(1-cv[,i], na.rm = TRUE)/10)
pro  <- matrix(DATA[12,], ncol = 3, byrow = TRUE)
pro4 <- sapply(1:3, function(i) mean(pro[,i], na.rm = TRUE))

load("2N30/HR1_p0.2.RData")
sauc <- matrix(DATA[11,], ncol = 3, byrow = TRUE)
med2  <- sapply(1:3, function(i) mean(sauc[,i], na.rm = TRUE))
cv  <- matrix(DATA[13,], ncol = 3, byrow = TRUE)
...
cv
prop  <- rbind(pro8, pro6, pro4, pro2)
prop
