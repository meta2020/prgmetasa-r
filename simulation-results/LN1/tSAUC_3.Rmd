---
title: "Simulation Result 3: LogN(0.2)"
author: "Yi"
date: "`r Sys.Date()`"
...
n30.08$sauc.val <- rbind(rep(NA, 3), n30.08$sauc.val)
...
```{r}
if (save.tex) sink("tb-sauc-s3-1.tex")
...
n20.04.2$sauc.val <- rbind(rep(NA, 3), n20.04.2$sauc.val)
...
```{r}
if (save.tex) sink("tb-sauc-s3-2.tex")
