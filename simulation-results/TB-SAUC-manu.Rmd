...
dimname.sauc <- list(c("M1BNM.P", "M2BNM.O", "M3prop1", "M4TNM.O","M5TNM.Prop"), "SAUC")
...
result_list <- function(path = "exp0.2/N20/ptdis2_HR1_p0.8.RData", 
                        dnm.cr = dimname.cr, dnm.sauc = dimname.sauc, only.conv=FALSE){ 
...
sauc <- data.frame(
	NN = c(N, rep(NA, 4)),
  Methods = c("HZ$_P$", "HZ$_O$","Prop.n", "Prop.o", "Prop"),
