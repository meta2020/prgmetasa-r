...
```{r}
if (save.tex) sink("TB-SAUC-HR1-EXP.tex")
...
```{r}
if (save.tex) sink("TB-SAUC-HR2-EXP.tex")
...
```{r}
# if (save.tex) sink("TB-SAUC-HR3-EXP.tex")
...
```{r}
if (save.tex) sink("TB-SAUC-HR1-UNIF.tex")
...
```{r}
if (save.tex) sink("TB-SAUC-HR2-UNIF.tex")
