---
title: "Simulation Result 1: Exp(0.2)"
author: "Yi"
date: "`r Sys.Date()`"
...
```{r}
if (save.tex) sink("tb-sauc-s1-1.tex")
...
```{r}
if (save.tex) sink("tb-sauc-s1-2.tex")
...
```{r}
if (saveplot) {setEPS(width = 9, height = 6); postscript("tsauc1.eps")}
