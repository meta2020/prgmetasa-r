...
dnmsauc <- list(c("M1BNM.P", "M2BNM.O", "M3TNM.P", "M4TNM.O","M5TNM.Prop"), "tSAUC")
dnmcr   <- list(c("M1BNM.P", "M2BNM.O", "M3TNM.P", "M4TNM.O","M5TNM.Prop"), "CR")
...
result_list <- function(path = "exp0.2/N20/ptdis2_HR1_p0.8.RData", 
  ...
  cr.sum  <- matrix(sapply(1:5, function(i) round(mean(1-cr[,i], na.rm = TRUE)*100,2)),5,1, dimnames = dnm.cr)
...
tsauc.tab <- function(FD, N, ptdist, HR, p1=0.8, p2=0.6, p3=0.4){
...
if (save.tex) sink("TB-SAUC-HR3-UNIF-CR.tex")
