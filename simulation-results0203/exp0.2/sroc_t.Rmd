...
SROC.tstat <- function(path, S, mk.id, a, ft.xlim = c(-0.5, 2.5), ft.ylim = c(0, 0.7)){
...
tf <- trimfill(res)
funnel(tf, xlab = "Observed lnHR", back="white", xlim = ft.xlim, ylim = ft.ylim)
...
SROC.tstat(path ="a-calc/beta1_pts50_150.RData", S=100, mk.id=2, a=-0.1, 
											ft.xlim = c(-2,2), ft.ylim = c(0, 0.8))
```


```{r, fig.width=12, fig.height=6}

SROC.tstat(path ="a-calc/beta1_pts50_150.RData", S=100, mk.id=2, a=-0.7, 
											ft.xlim = c(-2,2), ft.ylim = c(0, 0.8))
```
...
SROC.tstat(path ="a-calc/beta1_pts50_150.RData", S=100, mk.id=2, a=-1.3, 
											ft.xlim = c(-2,2), ft.ylim = c(0, 0.8))
```
...
SROC.tstat(path ="a-calc/beta1_pts50_150.RData", S=100, mk.id=3, a=-2, 
											ft.xlim = c(-0.5,3), ft.ylim = c(0, 0.8))
```


```{r, fig.width=12, fig.height=6}

SROC.tstat(path ="a-calc/beta1_pts50_150.RData", S=100, mk.id=3, a=-2.5, 
											ft.xlim = c(-0.5,3), ft.ylim = c(0, 0.8))
```
...
SROC.tstat(path ="a-calc/beta1_pts50_150.RData", S=100, mk.id=3, a=-3.2, 
											ft.xlim = c(-0.5,3), ft.ylim = c(0, 0.8))
```