...
subtile: "pt distribution U(50, 300)"
author: "Yi"
date: "`r Sys.Date()`"
...
p1.3 <- grp.bp(N20.D2.HR3.P0.9, N20.D2.HR3.P0.9, N20.D2.HR3.P0.7, N20.D2.HR3.P0.6, 
													N20.D2.HR3.P0.5, N20.D2.HR3.P0.4, N20.D2.HR3.P0.3, N20.D2.HR3.P0.2, N20.D2.HR3.P0.1,
             pS.lab = as.character(seq(0.9, 0.1, -0.1)), 
...
p2.3 <- grp.bp(N30.D2.HR3.P0.9, N30.D2.HR3.P0.9, N30.D2.HR3.P0.7, N30.D2.HR3.P0.6, 
													N30.D2.HR3.P0.5, N30.D2.HR3.P0.4, N30.D2.HR3.P0.3, N30.D2.HR3.P0.2, N30.D2.HR3.P0.1,
             pS.lab = as.character(seq(0.9, 0.1, -0.1)), 
...
p3.3 <- grp.bp(N50.D2.HR3.P0.9, N50.D2.HR3.P0.9, N50.D2.HR3.P0.7, N50.D2.HR3.P0.6, 
													N50.D2.HR3.P0.5, N50.D2.HR3.P0.4, N50.D2.HR3.P0.3, N50.D2.HR3.P0.2, N50.D2.HR3.P0.1,
             pS.lab = as.character(seq(0.9, 0.1, -0.1)), 
             title = "N = 50, HR3", ylim = c(0,1))
...
sauc.mq.20.3 <- cbind.data.frame(
  N = c(20, NA, NA, NA, NA),
  Methods = c("BNM$_P$", "BNM$_O$", "TNM$_P$", "TNM$_O$", "Prop"),
  N20.D2.HR3.P0.9$sauc.med.q13, N20.D2.HR3.P0.8$sauc.med.q13, N20.D2.HR1.P0.7$sauc.med.q13,
  N20.D2.HR3.P0.6$sauc.med.q13, N20.D2.HR3.P0.5$sauc.med.q13, N20.D2.HR1.P0.4$sauc.med.q13, 
  N20.D2.HR3.P0.3$sauc.med.q13, N20.D2.HR3.P0.2$sauc.med.q13, N20.D2.HR1.P0.1$sauc.med.q13)
...
sauc.mq.30.2 <- cbind.data.frame(
  N = c(30, NA, NA, NA, NA),
  Methods = c("BNM$_P$", "BNM$_O$", "TNM$_P$", "TNM$_O$", "Prop"),
  N30.D2.HR3.P0.9$sauc.med.q13, N30.D2.HR2.P0.8$sauc.med.q13, N30.D2.HR2.P0.7$sauc.med.q13,
...
sauc.mq.30.3 <- cbind.data.frame(
  N = c(30, NA, NA, NA, NA),
  Methods = c("BNM$_P$", "BNM$_O$", "TNM$_P$", "TNM$_O$", "Prop"),
  N30.D2.HR3.P0.9$sauc.med.q13, N30.D2.HR3.P0.8$sauc.med.q13, N30.D2.HR1.P0.7$sauc.med.q13,
  N30.D2.HR3.P0.6$sauc.med.q13, N30.D2.HR3.P0.5$sauc.med.q13, N30.D2.HR1.P0.4$sauc.med.q13, 
  N30.D2.HR3.P0.3$sauc.med.q13, N30.D2.HR3.P0.2$sauc.med.q13, N30.D2.HR1.P0.1$sauc.med.q13)
...
sauc.mq.50.3 <- cbind.data.frame(
  N = c(50, NA, NA, NA, NA),
  Methods = c("BNM$_P$", "BNM$_O$", "TNM$_P$", "TNM$_O$", "Prop"),
  N50.D2.HR3.P0.9$sauc.med.q13, N50.D2.HR3.P0.8$sauc.med.q13, N50.D2.HR3.P0.7$sauc.med.q13,
  N50.D2.HR3.P0.6$sauc.med.q13, N50.D2.HR3.P0.5$sauc.med.q13, N50.D2.HR3.P0.4$sauc.med.q13, 
  N50.D2.HR3.P0.3$sauc.med.q13, N50.D2.HR2.P0.2$sauc.med.q13, N50.D2.HR3.P0.1$sauc.med.q13)
...
```{r}
cv.20 <- data.frame(
	N20.D2.HR1.P0.9$cv.sum, N20.D2.HR1.P0.8$cv.sum, N20.D2.HR1.P0.7$cv.sum,
 N20.D2.HR1.P0.6$cv.sum, N20.D2.HR1.P0.5$cv.sum, N20.D2.HR1.P0.4$cv.sum, 
 N20.D2.HR1.P0.3$cv.sum, N20.D2.HR1.P0.2$cv.sum, N20.D2.HR1.P0.1$cv.sum)

cv.20.2 <- data.frame(
	N20.D2.HR2.P0.9$cv.sum, N20.D2.HR2.P0.8$cv.sum, N20.D2.HR2.P0.7$cv.sum,
 N20.D2.HR2.P0.6$cv.sum, N20.D2.HR2.P0.5$cv.sum, N20.D2.HR2.P0.4$cv.sum, 
 N20.D2.HR2.P0.3$cv.sum, N20.D2.HR2.P0.2$cv.sum, N20.D2.HR2.P0.1$cv.sum)

cv.20.3 <- data.frame(
	N20.D2.HR3.P0.9$cv.sum, N20.D2.HR3.P0.8$cv.sum, N20.D2.HR3.P0.7$cv.sum,
 N20.D2.HR3.P0.6$cv.sum, N20.D2.HR3.P0.5$cv.sum, N20.D2.HR3.P0.4$cv.sum, 
 N20.D2.HR3.P0.3$cv.sum, N20.D2.HR3.P0.2$cv.sum, N20.D2.HR3.P0.1$cv.sum)

cv.30 <- data.frame(
	N30.D2.HR1.P0.9$cv.sum, N30.D2.HR1.P0.8$cv.sum, N30.D2.HR1.P0.7$cv.sum,
 N30.D2.HR1.P0.6$cv.sum, N30.D2.HR1.P0.5$cv.sum, N30.D2.HR1.P0.4$cv.sum, 
 N30.D2.HR1.P0.3$cv.sum, N30.D2.HR1.P0.2$cv.sum, N30.D2.HR1.P0.1$cv.sum)

cv.30.2 <- data.frame(
	N30.D2.HR2.P0.9$cv.sum, N30.D2.HR2.P0.8$cv.sum, N30.D2.HR2.P0.7$cv.sum,
 N30.D2.HR2.P0.6$cv.sum, N30.D2.HR2.P0.5$cv.sum, N30.D2.HR2.P0.4$cv.sum, 
 N30.D2.HR2.P0.3$cv.sum, N30.D2.HR2.P0.2$cv.sum, N30.D2.HR2.P0.1$cv.sum)

cv.30.3 <- data.frame(
	N30.D2.HR3.P0.9$cv.sum, N30.D2.HR3.P0.8$cv.sum, N30.D2.HR3.P0.7$cv.sum,
 N30.D2.HR3.P0.6$cv.sum, N30.D2.HR3.P0.5$cv.sum, N30.D2.HR3.P0.4$cv.sum, 
 N30.D2.HR3.P0.3$cv.sum, N30.D2.HR3.P0.2$cv.sum, N30.D2.HR3.P0.1$cv.sum)

cv.50 <- data.frame(
	N50.D2.HR1.P0.9$cv.sum, N50.D2.HR1.P0.8$cv.sum, N50.D2.HR1.P0.7$cv.sum,
 N50.D2.HR1.P0.6$cv.sum, N50.D2.HR1.P0.5$cv.sum, N50.D2.HR1.P0.4$cv.sum, 
 N50.D2.HR1.P0.3$cv.sum, N50.D2.HR1.P0.2$cv.sum, N50.D2.HR1.P0.1$cv.sum)

cv.50.2 <- data.frame(
	N50.D2.HR2.P0.9$cv.sum, N50.D2.HR2.P0.8$cv.sum, N50.D2.HR2.P0.7$cv.sum,
 N50.D2.HR2.P0.6$cv.sum, N50.D2.HR2.P0.5$cv.sum, N50.D2.HR2.P0.4$cv.sum, 
 N50.D2.HR2.P0.3$cv.sum, N50.D2.HR2.P0.2$cv.sum, N50.D2.HR2.P0.1$cv.sum)

cv.50.3 <- data.frame(
	N50.D2.HR3.P0.9$cv.sum, N50.D2.HR3.P0.8$cv.sum, N50.D2.HR3.P0.7$cv.sum,
 N50.D2.HR3.P0.6$cv.sum, N50.D2.HR3.P0.5$cv.sum, N50.D2.HR3.P0.4$cv.sum, 
 N50.D2.HR3.P0.3$cv.sum, N50.D2.HR3.P0.2$cv.sum, N50.D2.HR3.P0.1$cv.sum)
...
hr.20.3 <- data.frame(
	N20.D2.HR3.P0.9$hr, N20.D2.HR3.P0.8$hr, N20.D2.HR3.P0.7$hr,
 N20.D2.HR3.P0.6$hr, N20.D2.HR3.P0.5$hr, N20.D2.HR3.P0.4$hr, 
 N20.D2.HR3.P0.3$hr, N20.D2.HR3.P0.2$hr, N20.D2.HR3.P0.1$hr)
...
hr.30.3 <- data.frame(
	N30.D2.HR3.P0.9$hr, N30.D2.HR3.P0.8$hr, N30.D2.HR3.P0.7$hr,
 N30.D2.HR3.P0.6$hr, N30.D2.HR3.P0.5$hr, N30.D2.HR3.P0.4$hr, 
 N30.D2.HR3.P0.3$hr, N30.D2.HR3.P0.2$hr, N30.D2.HR3.P0.1$hr)
...
hr.50.3 <- data.frame(
	N50.D2.HR3.P0.9$hr, N50.D2.HR3.P0.8$hr, N50.D2.HR3.P0.7$hr,
 N50.D2.HR3.P0.6$hr, N50.D2.HR3.P0.5$hr, N50.D2.HR3.P0.4$hr, 
 N50.D2.HR3.P0.3$hr, N50.D2.HR3.P0.2$hr, N50.D2.HR3.P0.1$hr)
